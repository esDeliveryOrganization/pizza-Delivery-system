class User < ApplicationRecord
  ...
  validates :nome, presence: true, length: {minimum: 3, too_short: "must have at least 3 characters "}, length: { maximum: 30, too_long: "must have at maximum 30 characters" }, format: {with: /\Ahttps?:\/\/[^\n]+\z/i}
