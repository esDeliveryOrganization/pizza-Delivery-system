...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, logradouro: @endereco.logradouro, user: @endereco.user } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, logradouro: @endereco.logradouro, user: @endereco.user } }
