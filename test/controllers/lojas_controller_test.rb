...
class LojasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loja" do
    assert_difference('Loja.count') do
      post lojas_url, params: { loja: { abertura: @loja.abertura, fechamento: @loja.fechamento } }
    end
  ...
  test "should update loja" do
    patch loja_url(@loja), params: { loja: { abertura: @loja.abertura, fechamento: @loja.fechamento } }
