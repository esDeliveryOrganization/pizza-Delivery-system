...
class EntregadorTest < ActiveSupport::TestCase
  ...
  test 'entregador deve ser salvo' do
    entregador = Entregador.new cpf: '70086904337', nome: 'Entregador de teste', telefone: '87999132760'
    assert entregador.save
  end

  # Edicao valida
  test 'entregador deve ser alterado' do
    entregador = Entregador.new cpf: '70086904338', nome: 'Entregador', telefone: '87999132767'
    assert entregador.save
  ...
  test 'entregador deve ser removido' do
    entregador = Entregador.new cpf: '70086904339', nome: 'Nome de teste', telefone: '87999132763'
    assert entregador.save
